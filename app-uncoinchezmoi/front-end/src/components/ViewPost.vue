      ...
      <div class="h-100">
        <div class="h-100">
          <v-form class="h-100 mt-auto d-flex flex-column justify-content-between">
            <v-card
              class="p-3 d-flex flex-column justify-content-between mb-5"
              :title="this.post.address"
            ...
            >
              ...
              <v-card-actions class="d-flex justify-content-between">
                <v-btn color="#4F685D" variant="outlined" rounded="pill" @click="openModif = true" append-icon="mdi-pen"
                  >Modifier</v-btn
                >
                <v-btn
                  color="danger"
