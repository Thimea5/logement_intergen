        ...
        <div class="login-wrapper">
            ...
            <form id="form-login" @submit.prevent="handleLogin" class="d-flex flex-column justify-space-between">
                ...
                <div class="text-center mt-5">
                    ...
                    <v-btn type="submit" color="#8DA399" rounded="xl" variant="flat" block class="login-button" :disabled="!isFormValid">
                        Connexion
                    </v-btn>
                </div>
            </form>
    ...
    export default {
        ...
        methods: {
            handleLogin() {
                ...
                axios
                .post(apiUrl + '/services/login.php',
                    {
                        email: this.email,
...
<style scoped>
    @font-face {
        ...
        src: url('@/assets/fonts/gilbi.ttf') format('truetype');
        font-style: italic;
    }
